          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ul className={`flex flex-nowrap items-center font-bold uppercase tracking-wider overflow-x-visible whitespace-nowrap scrollbar-none gap-0.5 ${sticky ? 'text-[10px]' : 'text-[10px] sm:text-[13px]'}`}>
              ...
              <li className="flex-none">
                <DropdownItem
                  label={
                    <Link to="/klientam" className={`hover:bg-[#d66f00] transition-colors duration-300 text-center block ${sticky ? 'py-2 px-1.5 sm:px-3' : 'py-2 px-1.5 sm:py-4 sm:px-6'}`}>��������</Link>
                  }
                >
                  <div className="hidden sm:block bg-white text-gray-700 shadow-xl border border-gray-100 rounded-b-lg min-w-[400px] p-5 -ml-20">
                    <ul className="space-y-3">
              ...
              <li className="flex-none">
                <DropdownItem
                  label={
                    <Link to="/o-kompanii" className={`hover:bg-[#d66f00] transition-colors duration-300 text-center block ${sticky ? 'py-2 px-1.5 sm:px-3' : 'py-2 px-1.5 sm:py-4 sm:px-6'}`}>� ��������</Link>
                  }
                >
                  <div className="hidden sm:block bg-white text-gray-700 shadow-xl border border-gray-100 rounded-b-lg min-w-[400px] p-5 -ml-20">
                    <ul className="space-y-3">
              ...
              {/* Контакты */}
              <li className="flex-none">
                <Link to="/kontakty" className={`hover:bg-[#d66f00] transition-colors duration-300 text-center block ${sticky ? 'py-2 px-1.5 sm:px-3' : 'py-2 px-1.5 sm:py-4 sm:px-6'}`}>��������</Link>
              </li>
            </ul>
