...
const categories = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1625650484478-113df4bfc370?auto=format&fit=crop&q=80&w=250',
    color: 'bg-[#fdf4e7]' // Light orange tint
  },
  {
    title: 'Наполнители для торговых\nавтоматов',
    image: 'https://images.unsplash.com/photo-1535368940502-0e42d76fba94?auto=format&fit=crop&q=80&w=250',
    color: 'bg-[#fdf4e7]'
  }
];
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 mb-8">
      <div className="flex justify-center gap-4 lg:gap-8 flex-wrap">
        {categories.map((cat, idx) => (
          <a key={idx} href="#" className="flex flex-col items-center group bg-white border border-gray-100 p-6 rounded hover:shadow-lg transition-shadow w-full max-w-[250px]">
