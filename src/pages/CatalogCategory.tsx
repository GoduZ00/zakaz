...
const faqItems = [
  {
    ...
    a: 'Наиболее надежными считаются автоматы с металлическим корпусом и проверенными механизмами выдачи. Мы предлагаем оборудование, которое прошло многолетнюю проверку рынка и служит без поломок.',
  },
  {
  ...
  },
  {
    ...
    a: 'Выбор монетоприемника зависит от типа автомата и монет, которые вы планируете принимать. Универсальные модели поддерживают большинство монет Казахстана.',
  },
  {
...
const seoTexts: Record<string, { title: string; description: string; paragraphs: string[] }> = {
  'torgovye-avtomaty': {
    title: 'Торговые автоматы — купить вендинговый автомат в Казахстане | VENDINGTRADE',
    description: 'Купить торговые автоматы для вендинга в Казахстане по оптовой цене. Механические автоматы, монетоприёмники, комплекты. Доставка по РК, гарантия 12 мес.',
    paragraphs: [
      'Купить торговый автомат для вендинг-бизнеса в Казахстане — это надёжный способ начать пассивный доход. Механические торговые автоматы не требуют подключения к электросети и установки в любом месте с высокой проходимостью: торговые центры, кинотеатры, вокзалы, школы.',
      'Мы продаём комплекты из 2 и 3 автоматов под жевательную резинку, конфеты, мячи-прыгуны и игрушки в капсулах. Простая конструкция обеспечивает надёжность и долгий срок службы, а оригинальные запчасти и монетоприёмники всегда в наличии.',
    ],
  },
  'zhevatelnaya-rezinka': {
    title: 'Жевательная резинка для вендинга оптом — купить в Казахстане | VENDINGTRADE',
    description: 'Жевательная резинка в капсулах для торговых автоматов оптом и в розницу. Диаметры 22–65 мм, более 300 000 шт на складе. Доставка по Казахстану.',
    paragraphs: [
      'Жевательная резинка — самый ходовой наполнитель для вендинговых автоматов. В каталоге VENDINGTRADE представлена жвачка в капсулах диаметром 22, 32, 45 и 58 мм: фрукты в сахаре, ассорти, с наклейками и без.',
      'Покупайте жевательную резинку для автоматов оптом с бесплатной доставкой по Казахстану от 20 000 ₸. Упаковки по 100, 200 и 300 штук — экономично для вендинг-бизнеса.',
    ],
  },
  'konfety': {
    title: 'Конфеты в капсулах для торговых автоматов — оптом | VENDINGTRADE',
    description: 'Конфеты для вендинговых автоматов оптом в Казахстане. Порционные сладости в капсулах 45–58 мм, жевательные и леденцы. Оптовые цены, доставка по РК.',
    paragraphs: [
      'Конфеты — ещё один востребованный наполнитель для торговых автоматов. Порционные жевательные и леденцовые конфеты в капсулах подходят для автоматов с диаметром выдачи 45, 53 и 58 мм.',
      'Заказывайте конфеты для вендинга оптом: выгодные цены за упаковку, всегда в наличии на складе в Алматы, доставка во все регионы Казахстана.',
    ],
  },
  'myachi-pryguny': {
    title: 'Мячи-прыгуны оптом для автоматов — купить в Казахстане | VENDINGTRADE',
    description: 'Мячи-прыгуны для вендинговых автоматов оптом: 25, 27, 32 и 45 мм, круглые и фигурные. Наполнитель для автоматов с высокой маржой. Доставка по РК.',
    paragraphs: [
      'Мячи-прыгуны — популярный и высокомаржинальный наполнитель для вендинговых автоматов. Круглые и фигурные мячики диаметром 25, 27, 32 и 45 мм продаются в 3–5 раз дороже закупки.',
      'Купите мячи-прыгуны оптом для своих автоматов: большой выбор цветов и рисунков, упаковка от 100 штук, бесплатная доставка по Казахстану от 20 000 ₸.',
    ],
  },
  'igrushki': {
    title: 'Игрушки в капсулах для торговых автоматов — оптом | VENDINGTRADE',
    description: 'Игрушки в капсулах для вендинга оптом в Казахстане: животные, техника, фигурки, сквиши, значки. Наполнители для автоматов 32–100 мм. Доставка по РК.',
    paragraphs: [
      'Игрушки в капсулах — самый прибыльный сегмент вендинга. В каталоге — животные, техника, фигурки людей, сквиши, лизуны, значки и наклейки для автоматов с капсулами от 32 до 100 мм.',
      'Поставляем игрушки для торговых автоматов оптом по всей территории Казахстана: отборные позиции, высокая маржа, регулярные новинки и пополнение ассортимента.',
    ],
  },
  'bakhily-v-kapsulakh': {
    title: 'Бахилы в капсулах для автоматов — купить оптом | VENDINGTRADE',
    description: 'Бахилы в капсулах для вендинговых автоматов оптом и в розницу. Востребованный товар у клиник, лабораторий, офисов. Доставка по Казахстану.',
    paragraphs: [
      'Бахилы в капсулах — практичный и всегда востребованный товар для вендинговых автоматов. Идеальны для установки в клиниках, лабораториях, офисах и торговых центрах.',
      'Покупайте бахилы в капсулах оптом: устойчивый спрос, отличная маржа, регулярные продажи. Наличие на складе и доставка по всем регионам Казахстана.',
    ],
  },
  'kapsuly-pustye': {
    title: 'Капсулы для вендинга пустые — купить оптом | VENDINGTRADE',
    description: 'Пустые капсулы для торговых автоматов оптом: 32, 45, 53, 58 мм, прозрачные и цветные. Для своей продукции и упаковки. Доставка по Казахстану.',
    paragraphs: [
      'Пустые капсулы — решение для тех, кто продаёт через автоматы собственную продукцию или упаковывает наполнители самостоятельно. Доступны диаметры 32, 45, 53 и 58 мм.',
      'Купите пустые капсулы для вендинга оптом: прозрачные и цветные варианты, прочный пластик, конкурентные цены и доставка по всему Казахстану.',
    ],
  },
  'stoyki-kronshteyny-shvellery': {
    title: 'Стойки, кронштейны, швеллеры для торговых автоматов | VENDINGTRADE',
    description: 'Стойки, кронштейны и швеллеры для торговых автоматов в Казахстане. Установка и закрепление автоматов в любом помещении. Доставка по РК.',
    paragraphs: [
      'Стойки, кронштейны и швеллеры — необходимые элементы для надёжной установки торговых автоматов. Они защищают оборудование от падения и порчи напольного покрытия.',
      'Подбираем и доставляем стойки, кронштейны и швеллеры для автоматов по всей территории Казахстана. В наличии все размеры для механических и напольных аппаратов.',
    ],
  },
  'detali-i-chasti': {
    title: 'Запчасти для торговых автоматов — купить в Казахстане | VENDINGTRADE',
    description: 'Запчасти и детали для торговых автоматов: монетоприёмники, замки, распределители, ключи. Ремонт и обслуживание. Доставка по Казахстану.',
    paragraphs: [
      'Запчасти и детали для торговых автоматов всегда в наличии: монетоприёмники, распределители, замки, ключи и механизмы выдачи. Ремонт оборудования — быстро и с гарантией.',
      'Купите запчасти для вендинговых автоматов: оригинальные комплектующие, совместимые с большинством моделей. Опт и розница, доставка по Казахстану.',
    ],
  },
  'monetopriemniki': {
    title: 'Монетоприёмники для торговых автоматов — купить | VENDINGTRADE',
    description: 'Монетоприёмники для вендинговых автоматов: номинал 50, 100 и 100+100 тенге. Универсальные модели. Доставка по Казахстану.',
    paragraphs: [
      'Монетоприёмник — «сердце» торгового автомата. Предлагаем надёжные модели на 50, 100 и 100+100 тенге, совместимые с большинством механических автоматов.',
      'Купите монетоприёмник для автомата с доставкой по Казахстану: простота настройки, стабильный приём монет и долгий срок службы.',
    ],
  },
  'raspredeliteli': {
    title: 'Распределители для торговых автоматов — купить | VENDINGTRADE',
    description: 'Распределители для вендинговых автоматов: 22, 25, 32 мм и порционные. Совместимость с наполнителями. Доставка по Казахстану.',
    paragraphs: [
      'Распределитель — механизм выдачи, который напрямую влияет на надёжность автомата. В наличии распределители под капсулы 22, 25, 32 мм и порционные.',
      'Подберите распределитель под ваш автомат: совместимость с наполнителями, простая установка, наличие на складе и доставка по Казахстану.',
    ],
  },
  'nakleyki': {
    title: 'Наклейки для торговых автоматов — купить | VENDINGTRADE',
    description: 'Наклейки для вендинговых автоматов: универсальные, индивидуальные и инструкции. Оформление аппарата под ваш бизнес. Доставка по РК.',
    paragraphs: [
      'Наклейки делают торговый автомат заметным и продающим. Предлагаем универсальные наклейки, индивидуальные под ваши наполнители и инструкции для покупателей.',
      'Закажите наклейки для автоматов с доставкой по Казахстану: яркий дизайн, влагостойкие материалы, изготовление по вашему макету.',
    ],
  },
};
...
export default function CatalogCategory() {
  ...
  return (
    <>
      <Helmet>
        <title>{seoTexts[categoryId]?.title || (category?.name ? `${category.name} — Vending Trade` : 'Каталог — Vending Trade')}</title>
        <meta name="description" content={seoTexts[categoryId]?.description || `${category?.name || 'Каталог'} — товары для вендинга. Купить в Казахстане с доставкой.`} />
        <meta property="og:title" content={seoTexts[categoryId]?.title || (category?.name ? `${category.name} — Vending Trade` : 'Каталог — Vending Trade')} />
        <meta property="og:description" content={seoTexts[categoryId]?.description || `${category?.name || 'Каталог'} — все для вендинг-бизнеса.`} />
          ...
          <div className="flex-1 min-w-0">
            ...
            {seoTexts[categoryId] && (
              <div className="bg-white border border-gray-200 rounded-sm p-6">
                <h2 className="text-lg font-bold text-gray-900 mb-4">{category.name}: подробнее</h2>
                <div className="text-sm text-gray-600 leading-relaxed space-y-3">
                  {seoTexts[categoryId].paragraphs.map((p, i) => (
                    <p key={i}>{p}</p>
                  ))}
                </div>
              </div>
