...
const categoryData: Record<string, CategoryData> = {
  'mekhanicheskie_torgovye_avtomaty_catalog': {
    ...
    subcategories: [
      ...
      { name: 'Диспенсеры', slug: 'dispensery' },
      { name: 'Купюроприемники', slug: 'kupyuropriemniki' },
      { name: 'Запчасти для торговых автоматов, ремкомплекты', slug: 'zapchasti' },
      { name: 'Замки и ключи', slug: 'zamki' },
      { name: 'Стикеры на торговые автоматы', slug: 'stikery' },
      { name: 'Стенды для напольных торговых автоматов', slug: 'steny' },
    ],
  },
...
const sidebarMenu = [
  {
    ...
    children: [
      ...
      'Диспенсеры',
      'Купюроприемники',
      'Запчасти для торговых автоматов, ремкомплекты',
      'Замки и ключи',
      'Стикеры на торговые автоматы',
      'Стенды для напольных торговых автоматов',
    ],
  },
  {
    name: 'Наполнители для торговых автоматов',
